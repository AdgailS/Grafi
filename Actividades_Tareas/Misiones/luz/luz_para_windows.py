...
def setup_lighting_basic():
    glEnable(GL_LIGHTING) ### ACTIVA EL SISTEMA DE LUCES
    glEnable(GL_LIGHT0) ### ACTIVA LA LUZ BÁSICA 
    glDisable(GL_LIGHT1) ### DESACTIVAN OTRAS LUCES 
    glDisable(GL_LIGHT2)
    
    light_position = [3.0, 2.0, 3.0, 1.0] ## POSICION DE LA LUZ  
    light_diffuse = [1.0, 1.0, 1.0, 1.0] ## POSICION LUZ DIFISA - ILUMINACION DIRECTA
    light_ambient = [0.3, 0.3, 0.3, 1.0] ## POSICION LUZ AMBIENTE - ILUMINACION GENERAL (SUAVE)
...
### PARA DIFERENTES TIPOS DE LUCES ###
...
def setup_lighting_directional():
    ### SE ACTIVAN LOS 3 TIPS DE LUCES ###
    ...
    glLightfv(GL_LIGHT0, GL_DIFFUSE, [1.0, 0.95, 0.8, 1.0]) ### POSICION X, Y, Z Y W
