...
MODEL_SCALE = 0.08  
WINDOW_TITLE = "Realidad Aumentada: Ciudad 3D sobre ArUco"
...
def draw_ar_city(scale: float) -> None:
    glPushMatrix()
...
def setup_lighting() -> None:
    ...
    # Ubicación y propiedades de la luz adaptadas para entorno abierto
...
def draw_scene_3d(rvec, tvec, camera_matrix, width, height, scale) -> None:
    ...
    # Dibujamos el entorno urbano con la escala actual
    draw_ar_city(scale)
...
def main() -> None:
    ...
    def on_key(win, key, _scancode, action, _mods):
        ...
        # Teclas '+' y '-' para calibrar el tamaño de la ciudad en vivo sobre el QR
    ...
    while not glfw.window_should_close(window):
        ...
        if corners is not None:
            ...
            # Renderizamos la escena pasando el parámetro de escala simplificado
            draw_scene_3d(rvec, tvec, camera_matrix, w, h, MODEL_SCALE)
